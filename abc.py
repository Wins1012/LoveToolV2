...
""")
		while True:
			...
			if option == 'layer4' or option == 'LAYER4':
				os.system('clear');self.ATK2()
			elif option == 'layer7' or option == 'LAYER7':
				os.system('clear');self.Method1()
...
""")
		...
		print(Color.LR+"["+Color.LG+"05"+Color.LR+"]"+Color.LC+" HTTP GET request flood")
...
def main():
	...
	VDH_TOOL.styleText("Tool Thuộc Bản Quyền Của Vi Đức Hùng...\n")
	VDH_TOOL.styleText("Hàng Free Không Đem Bán...\n")
	VDH_TOOL.styleText("LoveTool Version 2...\n\n")
	VDH_TOOL.home()
